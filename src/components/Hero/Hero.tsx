  ...
  return (
    <main className=" bg-red-custom ">
      <section className="max-w-[1180px] mx-auto flex flex-col gap-4 items-center justify-between lg:flex-row">
        <section className=" flex flex-col text-center pt-10 items-center w-full md:text-left">
          <h1 className="text-5xl	md:text-8xl md:text-left font-bold text-slate-900">
        ...
        <img src={santa} alt="" className=" w-72 lg:w-3/5" />
      </section>
